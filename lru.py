...
# if TYPE_CHECKING:
#     # type errors - correct
#     vc_t.member_callable("") # type: ignore[call-arg,arg-type,misc]
#     vc.member_callable(1, 1) # type: ignore[arg-type]
#     vc.member_callable(1) # type: ignore[call-arg,misc]
#     vc.member_callable("1") # type: ignore[call-arg,arg-type,misc]
...
# cfn_inst.fn(1)
# dbg(cfn_inst.fn)
# # dbg(cfn_inst.fn.__wrapped__)
# dbg(cfn_inst.fn.__func__)
...
# # CFnCls.cls_fn.cache_clear() - method type isn't merged with lru...
# if TYPE_CHECKING:
#     # type errors - correct
#     CFnCls().fn(1, 1) # type: ignore[call-arg]
# #     CFnCls().fn.__wrapped__(CFnCls(), 1, 1)
#     CFnCls.fn(arg=1) # type: ignore[call-arg]
#     CFnCls.st_fn(1, 1) # type: ignore[call-arg]
#     CFnCls.cls_fn(1, 1) # type: ignore[call-arg]
#     CFnCls.cls_fn_positional_only(CFnCls, 1) # type: ignore[call-arg,arg-type]
#     CFnCls().cls_fn_positional_only(CFnCls, 1) # type: ignore[call-arg,arg-type]
#     CFnCls.cls_fn_explicit_positional_only(CFnCls, 1) # type: ignore[call-arg,arg-type]
#     CFnCls().cls_fn_explicit_positional_only(CFnCls, 1) # type: ignore[call-arg,arg-type]
...
# if TYPE_CHECKING:
#     # type error - correct
#     fn_overload(frozenset({1,2})) # type: ignore[call-overload]
...
#     no_cache(Unhashable(), 2) # type: ignore[call-overload]
...
# # def set_member[**P, R](lhs: MemberVarBound[P, R], rhs: MemberVarBound[P, R]) -> None:
# #     rhs.equals

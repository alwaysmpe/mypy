...
_C_co = TypeVar("_C_co", bound=Callable[..., Any], covariant=True)
class staticmethod(Generic[_C_co]):
    @property
    def __func__(self) -> _C_co: ...
    @property
    def __isabstractmethod__(self) -> bool: ...
    def __init__(self, f: _C_co, /) -> None: ...
    @overload
    def __get__(self, instance: None, owner: type[Any], /) -> _C_co: ...
    @overload
    def __get__(self, instance: _T, owner: type[_T] | None = None, /) -> _C_co: ...
    if sys.version_info >= (3, 10):
        __name__: str
        __qualname__: str
        @property
        def __wrapped__(self) -> _C_co: ...
        def __call__(self: staticmethod[Callable[_P, _R_co]], *args: _P.args, **kwargs: _P.kwargs) -> _R_co: ...
...
class classmethod(Generic[_Class_co]):
    ...
    @overload
    def __get__(self: classmethod[Callable[Concatenate[type[_T], _P], _R_co]], instance: None, owner: type[_T], /) -> types.MethodType[_P, _R_co, classmethod[_C_co]]: ...
    @overload
    def __get__(self: classmethod[Callable[Concatenate[type[_T], _P], _R_co]], instance: _T, owner: type[_T] | None = None, /) -> types.MethodType[_P, _R_co, classmethod[_C_co]]: ...
    if sys.version_info >= (3, 10):
        __name__: str
        __qualname__: str
        @property
...
_V = TypeVar("_V")
class _StaticAttribute(Protocol[_V]): # type: ignore
    # avoid invoking `__get__` binding for wrapped functions.
    def __get__(self, instance: Any | None, owner: Any | None, /) -> _V: ...

_Gt_co = TypeVar("_Gt_co", default=None, covariant=True)
_Gr = TypeVar("_Gr")
_St = TypeVar("_St", default=None)
_Sr = TypeVar("_Sr")
_Dt = TypeVar("_Dt", default=None)
_Dr = TypeVar("_Dr")

class property(Generic[_Gt_co, _St, _Dt]):
    fget: _StaticAttribute[_Gt_co]
    fset: _StaticAttribute[_St]
    fdel: _StaticAttribute[_Dt]
    ...
    def getter(self, fget: _Gr, /) -> property[_Gr, _St, _Dt]: ...
    def setter(self, fset: _Sr, /) -> property[_Gt_co, _Sr, _Dt]: ...
    def deleter(self, fdel: _Dr, /) -> property[_Gt_co, _St, _Dr]: ...

    @overload
    def __get__(self, instance: None, owner: type[Any], /) -> Self: ...
    @overload
    def __get__(self: property[Callable[..., _R_co], Any, Any], instance: Any, owner: type[Any] | None = None, /) -> _R_co: ...

    def __set__(self: property[Any, Callable[[Any, _V], Any], Any], instance: object, value: _V, /) -> None: ...
    def __delete__(self: property[Any, Any, Callable[[Any], Any]], instance: object, /) -> None: ...
